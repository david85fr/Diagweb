...
inline const std::vector<ProtocolDesc>& protocols_desc() {
  ...
  { "iec61850", "IEC 61850", "Ethernet niveau 2 (GOOSE, SV) · ISO sur TCP (MMS)",
    "live", "Quatre mécanismes très différents cohabitent dans la norme. GOOSE et Sampled Values sont des trames Ethernet diffusées, sans session ni négociation : elles sont lues. La lecture MMS et les rapports (BRCB, URCB) roulent sur une pile ISO complète, non implémentée — leur configuration se saisit et se conserve, mais le lien reste « non branché ». Voir docs/PROTOCOLES.md.",
    {
    ...
    { "pollMs", "Période d’interrogation (ms)", "int", "1000", false, "Cadence des lectures MMS.", "" },
    },
    {
    ...
    { "index", "Indice dans le jeu de données", "int", "0", false, "Rang de l’entrée dans le dataset, à partir de 0, tel que le fichier SCL le fixe. Les membres d’une structure comptent chacun pour une entrée.", "" },
    ...
    { "ref", "Référence d’objet", "text", "", false, "Référence complète de l’attribut, par exemple LD0/MMXU1.A.phsA.cVal.mag.f.", "" },
